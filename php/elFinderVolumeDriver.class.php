...
abstract class elFinderVolumeDriver {
	...
	public function mount(array $opts) {
		...
		$fileMimeContentType = mime_content_type(__FILE__);
		$fileMimeContentTypeArr = explode(';', $fileMimeContentType);
		$fileMimeContentTypeArrShift = array_shift($fileMimeContentTypeArr);
		...
		&& preg_match($regexp, $fileMimeContentTypeArrShift)) {
